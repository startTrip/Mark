...
import com.mihua.market.fragments.ClassifyFragment;
import com.mihua.market.fragments.GocartFragment;
import com.mihua.market.fragments.HomeFragment;
import com.mihua.market.fragments.PersonalFragment;
...
public class MarketMainActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private void initData() {
        ...
        mList.add(new GocartFragment());
        mList.add(new PersonalFragment());
